...
function whichButton(x){
    ...
    document.getElementById('iHave').innerHTML = '<input type="text" size="35"><button class="questy" onclick="checkMyAnswer('+whichQs+')">Check</button>';
    
    document.getElementById('butThey').innerHTML = '<input type="text" size="35"><button class="questy1" onclick="checkMyAnswer1('+whichQs+')">Check</button>';
...
function checkMyAnswer(x){
    let storedA = iHave[x-1];
    let typedA = document.querySelector('#iHave input').value;
    console.log(storedA + "   " + typedA);  
    if(storedA == typedA){
        document.querySelector('#iHave input').style.backgroundColor = "lightgreen";
        document.querySelector('.questy').style.visibility = "hidden";
        document.getElementById('butThey').style.visibility = 'visible';
    }
}   


function checkMyAnswer1(x){
    let storedA = butThey[x-1];
    let typedA = document.querySelector('#butThey input').value;
    console.log(storedA + "   " + typedA);  
    if(storedA == typedA){
        document.querySelector('#butThey input').style.backgroundColor = "lightgreen";
        document.querySelector('.questy1').style.visibility = "hidden";
    }
}       